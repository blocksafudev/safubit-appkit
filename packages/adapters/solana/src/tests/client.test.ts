...
import { SafeLocalStorage, type CaipNetwork } from '@safubit/appkit-common'
import { ProviderUtil } from '@safubit/appkit/store'
import { SolHelpersUtil } from '@safubit/appkit-utils/solana'
...
import { CaipNetworksUtil } from '@safubit/appkit-utils'
...
vi.mock('@safubit/appkit-utils/solana', () => ({
  SolHelpersUtil: {
