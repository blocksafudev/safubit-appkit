...
import { EthersHelpersUtil, type ProviderType } from '@safubit/appkit-utils/ethers'
import { CaipNetworksUtil, ConstantsUtil } from '@safubit/appkit-utils'
import {
...
import { SafeLocalStorage, SafeLocalStorageKeys } from '@safubit/appkit-common'
import { type BlockchainApiLookupEnsName } from '@safubit/appkit'
import { ethers } from 'ethers'

import type { CaipNetwork, ChainNamespace } from '@safubit/appkit-common'
...
vi.mock('@safubit/appkit-utils', async importOriginal => {
