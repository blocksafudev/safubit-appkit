import type { RouterControllerState } from '@safubit/appkit-core'
import { RouterController, TooltipController } from '@safubit/appkit-core'
...
export class W3mRouter extends LitElement {
  ...
  private viewTemplate() {
    switch (this.view) {
      ...
      case 'OnSyncTelegramProviders':
        return html`<w3m-onsynctelegram-providers-view></w3m-onsynctelegram-providers-view>`
      case 'OnRampActivity':
