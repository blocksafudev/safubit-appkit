...
import '@safubit/appkit-ui/src/composites/wui-all-wallets-image'
import type { WuiAllWalletsImage } from '@safubit/appkit-ui/src/composites/wui-all-wallets-image'
