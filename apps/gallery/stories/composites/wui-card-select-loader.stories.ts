...
import '@safubit/appkit-ui/src/composites/wui-card-select-loader'
import type { WuiCardSelectLoader } from '@safubit/appkit-ui/src/composites/wui-card-select-loader'
